...
| V-17 | API do `otplib` na versão instalada | Não verificado | Tolerância de ±1 passo, anti-reuso feito pelo nosso código. Ver [ADR 0013](adr/0013-autenticacao-com-duas-etapas.md) | Conferir na documentação da versão instalada como configurar a tolerância e como obter o passo do código aceito |
